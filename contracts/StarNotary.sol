...
contract StarNotary is ERC721Full {
    ...
    constructor() public ERC721Full("Creative","CRT") {}
    //constructor(string memory _name, string memory _symbol) ERC721Full("Creative", "CRT") public {}
    ...
    function lookUptokenIdToStarInfo (uint256 _tokenId) external view returns (string memory) {
